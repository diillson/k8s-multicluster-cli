...
var cordonCmd = &cobra.Command{
	Use:   "cordon NODE",
	Short: "Marca um node como unschedulable (cordon, kubectl cordon)",
	Args:  cobra.ExactArgs(1),
	Run:   runCordonUniversal,
}
...
func runCordonUniversal(cmd *cobra.Command, args []string) {
	node := args[0]
	...
	utils.OutputCordon(handler.Results, "cordon")
}
