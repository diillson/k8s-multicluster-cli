...
var whoamiCmd = &cobra.Command{
	Use:   "whoami",
	Short: "Mostra o usuário autenticado (kubectl-style)",
	Run:   runWhoamiUniversal,
}
...
func runWhoamiUniversal(cmd *cobra.Command, _ []string) {
	...
	utils.OutputWhoami(handler.Results)
}
